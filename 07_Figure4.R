tiff("./../04_Figures/CurrentNew/Figure4.tiff", width = 16, height = 17, res = 300, unit = "cm")
par(mfrow = c(4,4), oma = c(0.1, 0.1, 0.1, 0.1), mar = c(2.5, 2.4, 2, 0.1), mgp = c(1.1, 0.2, 0), tck = -0.01, las = 1,
...
abline(h = 1.96, lty = 2, col = "darkgrey")
text(x = 2400, y = 2.75, "Diet", cex = 1.5, bty = "n")
...
abline(h = -1.96, lty = 2, col = "darkgrey")
abline(h = 1.96, lty = 2, col = "darkgrey")
text(x = 2200, y = 2.75, "Forag.", cex = 1.5, bty = "n")
...
abline(h = -1.96, lty = 2, col = "darkgrey")
abline(h = 1.96, lty = 2, col = "darkgrey")
text(x = 2200, y = 2.75, "Pri.Sub.", cex = 1.5, bty = "n")
...
abline(h = -1.96, lty = 2, col = "darkgrey")
abline(h = 1.96, lty = 2, col = "darkgrey")
text(x = 2400, y = 2.75, "Hab.", cex = 1.5, bty = "n")
