tiff("./../04_Figures/CurrentNew//FigureS3.tiff", width = 16, height = 16, res = 300, unit = "cm")
...
points(x1, null1.mpd.wing_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
...
points(x1, null1.mntd.wing_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
...
points(x1, null1.mpd.wing_winter$mpd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
...
points(x1, null1.mntd.wing_winter$mntd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
...
#################### PLOT 1
plot(x1, y1, pch = summer_pch, cex = 1.2, col = summer_colors, xlab = "", ylab = "SES(MPD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mpd.tarsus_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y1, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y1 ~ x1)
summary(model_1)
xvals = seq(min(x1), max(x1), length.out = 100)
...
#################### PLOT 2
plot(x1, y2, pch = summer_pch, cex = 1.2, col = summer_colors, xlab = "", ylab = "SES(MNTD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mntd.tarsus_summer$mntd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y2, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y2 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
...
#################### PLOT 3
plot(x1, y3, pch = winter_pch, cex = 1.2, col = winter_colors, xlab = "", ylab =  "SES(MPD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mpd.tarsus_winter$mpd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
points(x1, y3, pch = winter_pch, cex = 1.2, col = winter_colors)
model_1 <- lm(y3 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
...
#################### PLOT 4
plot(x1, y4, pch = winter_pch, cex = 1.2, col =  winter_colors, xlab = "", ylab = "SES(MNTD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mntd.tarsus_winter$mntd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
points(x1, y4, pch = winter_pch, cex = 1.2, col = winter_colors)
model_1 <- lm(y4 ~ x1)
summary(model_1)
xvals = seq(min(x1), max(x1), length.out = 100)
...
#################### PLOT 1
plot(x1, y1, pch = summer_pch, cex = 1.2, col = summer_colors, xlab = "", ylab = "SES(MPD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mpd.beak_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y1, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y1 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
...
#################### PLOT 2
plot(x1, y2, pch = summer_pch, cex = 1.2, col = summer_colors, xlab = "", ylab = "SES(MNTD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mntd.beak_summer$mntd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y2, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y2 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
...
#################### PLOT 3
plot(x1, y3, pch = winter_pch, cex = 1.2, col = winter_colors, xlab = "", ylab =  "SES(MPD)", xaxt = "n", ylim = c(-3,3))
points(x1, null1.mpd.beak_winter$mpd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
points(x1, y3, pch = winter_pch, cex = 1.2, col = winter_colors)
model_1 <- lm(y3 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
...
points(x1, null1.mpd.mass_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y1, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y1 ~ x1)
summary(model_1)
xvals = seq(min(x1), max(x1), length.out = 100)
...
points(x1, null1.mntd.mass_summer$mpd.obs.z[-1], pch = summer_pch, cex = 1.2, col = "grey75")
points(x1, y2, pch = summer_pch, cex = 1.2, col = summer_colors)
model_1 <- lm(y2 ~ x1)
summary(model_1)
xvals = seq(min(x1), max(x1), length.out = 100)
...
points(x1, null1.mpd.mass_winter$mpd.obs.z, pch = winter_pch, cex = 1.2, col = "grey75")
points(x1, y3, pch = winter_pch, cex = 1.2, col = winter_colors)
model_1 <- lm(y3 ~ x1)
summary(model_1)
abline(h = 0, lty = 1, lwd = 1, col = "black")
